...
(0, _axiosDefault.default).get("https://jsonplaceholder.typicode.com/todos").then(function(response) {
    // handle success
    let str = "";
    for(let key in response.data)str += response.data[key].title + "<br />";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequireb05f")
